...
class RotateScaleStartDetails {
  ...
  RotateScaleStartDetails({this.focalPoint = Offset.zero});
...
class RotateScaleEndDetails {
  ...
  RotateScaleEndDetails({this.velocity = Velocity.zero});
...
typedef GestureRotateScaleStartCallback = void Function(
    RotateScaleStartDetails details);

/// Signature for when the pointers in contact with the screen have indicated a
/// new focal point and/or scale.
typedef GestureRotateScaleUpdateCallback = void Function(
    RotateScaleUpdateDetails details);

/// Signature for when the pointers are no longer in contact with the screen.
typedef GestureRotateScaleEndCallback = void Function(
    RotateScaleEndDetails details);
...
class RotateScaleGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  RotateScaleGestureRecognizer({Object? debugOwner})
      : super(debugOwner: debugOwner);

  /// The pointers in contact with the screen have established a focal point and
  /// initial scale of 1.0.
  late GestureRotateScaleStartCallback onStart;

  /// The pointers in contact with the screen have indicated a new focal point
  /// and/or scale.
  late GestureRotateScaleUpdateCallback onUpdate;

  /// The pointers are no longer in contact with the screen.
  late GestureRotateScaleEndCallback onEnd;
  ...
  bool _reconfigure(int pointer) {
    ...
    if (_state == _ScaleState.started) {
      ...
      if (_isFlingGesture(velocity)) {
        ...
        invokeCallback<void>(
            'onEnd', () => onEnd(RotateScaleEndDetails(velocity: velocity)));
      } else {
        invokeCallback<void>('onEnd',
            () => onEnd(RotateScaleEndDetails(velocity: Velocity.zero)));
      }
  ...
  void _dispatchOnStartCallbackIfNeeded() {
    ...
    invokeCallback<void>('onStart',
        () => onStart(RotateScaleStartDetails(focalPoint: _currentFocalPoint)));
  }
